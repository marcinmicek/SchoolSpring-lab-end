...
public class SchoolClassesController {
    ...
    public String updateSchool(@RequestParam(value="schoolClassId", required=false) String schoolClassId,
    	...
    	DatabaseConnector.getInstance().updateSchoolClass(schoolClassId, startYear, currentYear, profile, schoolId);    	
       	model.addAttribute("schoolClasses", DatabaseConnector.getInstance().getSchoolClasses());
    	model.addAttribute("schools", DatabaseConnector.getInstance().getSchools());
